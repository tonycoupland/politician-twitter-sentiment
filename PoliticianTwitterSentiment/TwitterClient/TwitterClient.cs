namespace PoliticianTwitterSentiment.TwitterClient
{
	using System;
	...
	public class TwitterClient
	{
		...
		public async Task<IEnumerable<Tweet>> HomeTimelineStatuses(int count = 20)
		{
            return await this.GetTweets("https://api.twitter.com/1.1/statuses/home_timeline.json?count=" + count)
                             .ConfigureAwait(false);
		}
