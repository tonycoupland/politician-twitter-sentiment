...
namespace PoliticianTwitterSentiment.Sentiment
{
    public class Sentiment
    {
        ...
        private Sentiment()
        {
            ...
            using (var stream = new FileStream(@"Sentiment/db/AFINN-111.txt", FileMode.Open))
            {
        ...
        public class Score
        {
			...
			/// Average sentiment score Sentiment/Words.Count
			/// </summary>
			public decimal SentimentNormalised 
            { 
                get 
                {
                    if (Words.Count == 0) return 0m;
                    return (decimal)Sentiment / 5 / Words.Count(); 
                } 
            }
